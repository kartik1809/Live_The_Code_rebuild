...
export const MacbookScroll = ({
  ...
  return (
    (<div
      ref={ref}
      className="min-h-[200vh] mt-[-200px] sm:mt-0  flex flex-col items-center py-0 md:py-0  justify-start flex-shrink-0 w-full min-w-full [perspective:800px] transform md:scale-400  scale-[0.55] sm:scale-90">
      <motion.h2
        style={{
          translateY: textTransform,
          opacity: textOpacity,
        }}
        className="text-white text-4xl font-bold mb-20 text-center">
        {title || (
          <span className="xs:text-5xl">
            Join The Journey
          </span>
        )}
      </motion.h2>
      ...
      <div
        ...
        {showGradient && (
          <div
            className="h-40 w-full absolute bottom-0 inset-x-0 bg-gradient-to-t from-black via-black to-transparent -z-1"></div>
        )}
