                        ...
                        <div className="relative">
                            ...
                            <div className="timeline" ref={(el) => timelineRef.current[0] = el}>
                                <a href="#" className="timeline-content">
                                    <div className="timeline-year bg-blue-500 text-white rounded-full w-48 h-12 flex items-center justify-center">10 August 2024</div>
                            ...
                            <div className="timeline" ref={(el) => timelineRef.current[1] = el}>
                                <a href="#" className="timeline-content">
                                    <div className="timeline-year bg-blue-500 text-white rounded-full w-48 h-12 flex items-center justify-center">04 September 2024</div>
                            ...
                            <div className="timeline" ref={(el) => timelineRef.current[2] = el}>
                                <a href="#" className="timeline-content">
                                    <div className="timeline-year bg-blue-500 text-white rounded-full w-48 h-12 flex items-center justify-center">11 September 2024</div>
                            ...
                            <div className="timeline" ref={(el) => timelineRef.current[3] = el}>
                                <a href="#" className="timeline-content">
                                    <div className="timeline-year bg-blue-500 text-white rounded-full w-48 h-12 flex items-center justify-center">13 September 2024</div>
                            ...
                            <div className="timeline" ref={(el) => timelineRef.current[4] = el}>
                                <a href="#" className="timeline-content">
                                    <div className="timeline-year bg-blue-500 text-white rounded-full w-48 h-12 flex items-center justify-center">17 September 2024</div>
                            ...
                            <div className="timeline" ref={(el) => timelineRef.current[5] = el}>
                                <a href="#" className="timeline-content">
                                    <div className="timeline-year bg-green-500 text-white rounded-full w-48 h-12 flex items-center justify-center">19 September 2024</div>
